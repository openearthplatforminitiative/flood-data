...
def get_filtered_discharge_from_files(discharge_file_path, upstream_file_path, 
                                      threshold_area=250*1e6, discharge_engine="cfgrib", 
...
def apply_upstream_threshold(ds_discharge, ds_upstream, threshold_area=250*1e6, buffer=0.0125):

    subset_uparea = restrict_dataset_area(ds_upstream['uparea'],
