...
def generate_test_data(discharge_latitudes, discharge_longitudes, 
    ...
    dis24 = np.full((num_forecasts, num_steps, len(discharge_latitudes), 
                     len(discharge_longitudes)), fill_discharge)
    ...
    random_lat_indices = np.random.randint(lat_indices_range[0], lat_indices_range[1], num_random_cells)
    random_lon_indices = np.random.randint(lon_indices_range[0], lon_indices_range[1], num_random_cells)
