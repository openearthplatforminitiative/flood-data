...
class TestSparkUtilities(unittest.TestCase):
    ...
    def test_compute_flood_tendency(self):
        ...
        data = [
            ...
            (0.0, 0.5, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-05", 3, 0.1, 0.2, 0.3, 10.5, 11.5, 15.0, 16.0, 17.0),
            ...
            (1.25, 1.0, 20.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-05", 3, 0.1, 0.2, 0.3, 16.5, 17.5, 18.0, 20.5, 21.5),
            ...
            (2.0, 2.6, 25.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-05", 3, 0.1, 0.2, 0.3, 23.5, 24.5, 26.5, 27.5, 28.5),
    ...
    def test_compute_peak_timing(self):
        ...
        data_grayed_color_1 = [
            ...
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-19", 17, 0.03, 0.24, 0.0, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-20", 18, 0.1, 0.23, 0.27, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-21", 19, 0.2, 0.22, 0.01, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-22", 20, 0.21, 0.12, 0.06, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-23", 21, 0.29, 0.16, 0.18, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-24", 22, 0.12, 0.19, 0.19, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-25", 23, 0.15, 0.07, 0.03, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-26", 24, 0.19, 0.17, 0.12, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-27", 25, 0.05, 0.06, 0.28, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-28", 26, 0.04, 0.14, 0.04, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-29", 27, 0.0, 0.27, 0.16, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-30", 28, 0.1, 0.22, 0.11, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-31", 29, 0.2, 0.21, 0.29, 17.0, 18.0, 19.0, 20.0, 21.0),
            (0.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-11-01", 30, 0.24, 0.20, 0.04, 17.0, 18.0, 19.0, 20.0, 21.0),
        ]

        data_grayed_color_2 = [
            
            # Days 1-10 have p_above_2y < 0.30, p_above_5y < 0.30, and p_above_20y < 0.30
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-03", 1, 0.20, 0.2, 0.10, 9.0, 10.0, 11.0, 12.0, 13.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-04", 2, 0.0, 0.2, 0.11, 9.0, 10.0, 11.0, 12.0, 13.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-05", 3, 0.21, 0.27, 0.29, 9.0, 10.0, 11.0, 12.0, 13.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-06", 4, 0.29, 0.01, 0.27, 9.0, 10.0, 11.0, 12.0, 13.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-07", 5, 0.0, 0.2, 0.18, 9.0, 10.0, 11.0, 12.0, 13.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-08", 6, 0.10, 0.11, 0.11, 9.0, 10.0, 11.0, 12.0, 13.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-09", 7, 0.11, 0.16, 0.0, 9.0, 10.0, 11.0, 12.0, 13.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-10", 8, 0.19, 0.25, 0.0, 9.0, 10.0, 11.0, 12.0, 13.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-11", 9, 0.01, 0.0, 0.01, 9.0, 10.0, 11.0, 12.0, 13.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-12", 10, 0.23, 0.1, 0.05, 9.0, 10.0, 11.0, 12.0, 13.0),

            # Days 11-25 have p_above_5y sometimes above 0.30, and p_above_20y < 0.30
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-13", 11, 0.29, 0.24, 0.22, 17.0, 18.0, 23.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-14", 12, 0.30, 0.29, 0.10, 17.0, 18.0, 19.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-15", 13, 0.29, 0.28, 0.19, 17.0, 18.0, 19.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-16", 14, 0.27, 0.22, 0.28, 17.0, 18.0, 19.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-17", 15, 0.2, 0.1, 0.0, 17.0, 18.0, 19.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-18", 16, 0.3, 0.2, 0.03, 17.0, 18.0, 19.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-19", 17, 0.53, 0.24, 0.0, 17.0, 18.0, 19.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-20", 18, 0.5, 0.23, 0.27, 17.0, 18.0, 19.9, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-21", 19, 0.37, 0.33, 0.01, 17.0, 18.0, 19.2, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-22", 20, 1.0, 0.9, 0.06, 17.0, 18.0, 19.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-23", 21, 1.0, 1.0, 0.18, 17.0, 18.0, 19.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-24", 22, 0.62, 0.12, 0.19, 17.0, 18.0, 40.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-25", 23, 0.75, 0.15, 0.03, 17.0, 18.0, 100.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-26", 24, 1.0, 1.0, 0.12, 17.0, 18.0, 19.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-27", 25, 0.8, 0.3, 0.28, 17.0, 18.0, 19.4, 20.0, 21.0),

            # Day 26 has the highest severity with p_above_5y > 0.3 and the largest median discharge = 19.5
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-28", 26, 0.64, 0.34, 0.04, 17.0, 18.0, 19.5, 20.0, 21.0),

            # Days 27-30 have p_above_5y sometimes above 0.30, and p_above_20y < 0.30
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-29", 27, 0.95, 0.45, 0.16, 17.0, 18.0, 19.3, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-30", 28, 1.0, 0.52, 0.11, 17.0, 18.0, 19.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-31", 29, 1.0, 0.2, 0.29, 17.0, 18.0, 19.0, 20.0, 21.0),
            (5.0, 0.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-11-01", 30, 0.29, 0.24, 0.04, 17.0, 18.0, 19.0, 20.0, 21.0),
        ]

        data_grayed_color_3 = [
            
            # Days 1-10 have p_above_2y < 0.30, p_above_5y < 0.30, and p_above_20y < 0.30
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-03", 1, 0.20, 0.2, 0.10, 9.0, 10.0, 11.0, 12.0, 13.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-04", 2, 0.0, 0.2, 0.11, 9.0, 10.0, 11.0, 12.0, 13.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-05", 3, 0.21, 0.27, 0.29, 9.0, 10.0, 11.0, 12.0, 13.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-06", 4, 0.29, 0.01, 0.27, 9.0, 10.0, 11.0, 12.0, 13.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-07", 5, 0.0, 0.2, 0.18, 9.0, 10.0, 11.0, 12.0, 13.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-08", 6, 0.10, 0.11, 0.11, 9.0, 10.0, 11.0, 12.0, 13.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-09", 7, 0.11, 0.16, 0.0, 9.0, 10.0, 110000.0, 120000.0, 130000.0), # big median discharge
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-10", 8, 0.19, 0.25, 0.0, 9.0, 10.0, 11.0, 12.0, 13.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-11", 9, 0.01, 0.0, 0.01, 9.0, 10.0, 11.0, 12.0, 13.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-12", 10, 0.23, 0.1, 0.05, 9.0, 10.0, 11.0, 12.0, 13.0),

            # Days 11-13 have p_above_2y sometimes above 0.30, p_above_5y < 0.30 and p_above_20y < 0.30
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-13", 11, 0.29, 0.24, 0.22, 17.0, 18.0, 23.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-14", 12, 0.30, 0.29, 0.10, 17.0, 18.0, 19.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-15", 13, 0.29, 0.28, 0.19, 17.0, 18.0, 19.0, 20.0, 21.0),

            # Day 14 has the highest severity with p_above_2y > 0.3 and the largest median discharge = 19.6
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-16", 14, 0.32, 0.22, 0.28, 17.0, 18.0, 19.6, 20.0, 21.0),

            # Days 15-30 have p_above_2y sometimes above 0.30, p_above_5y < 0.30 and p_above_20y < 0.30
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-17", 15, 0.2, 0.1, 0.0, 17.0, 18.0, 19.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-18", 16, 0.3, 0.2, 0.03, 17.0, 18.0, 19.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-19", 17, 0.53, 0.24, 0.0, 17.0, 18.0, 19.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-20", 18, 0.5, 0.23, 0.27, 17.0, 18.0, 19.2, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-21", 19, 0.37, 0.13, 0.01, 17.0, 18.0, 19.2, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-22", 20, 1.0, 0.14, 0.06, 17.0, 18.0, 19.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-23", 21, 1.0, 0.22, 0.18, 17.0, 18.0, 19.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-24", 22, 0.62, 0.12, 0.19, 17.0, 18.0, 19.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-25", 23, 0.15, 0.15, 0.03, 17.0, 18.0, 99.0, 100.0, 101.0),  # big median discharge
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-26", 24, 1.0, 0.2, 0.12, 17.0, 18.0, 19.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-27", 25, 0.8, 0.29, 0.28, 17.0, 18.0, 19.4, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-28", 26, 0.64, 0.14, 0.04, 17.0, 18.0, 19.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-29", 27, 0.95, 0.25, 0.16, 17.0, 18.0, 19.3, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-30", 28, 1.0, 0.22, 0.11, 17.0, 18.0, 19.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-31", 29, 1.0, 0.2, 0.29, 17.0, 18.0, 19.0, 20.0, 21.0),
            (3.0, 2.975, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-11-01", 30, 0.29, 0.24, 0.04, 17.0, 18.0, 19.0, 20.0, 21.0),
        ]

        data_grayed_color_4 = [
            
            # Days 1-10 have p_above_2y < 0.30, p_above_5y < 0.30, and p_above_20y < 0.30
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-03", 1, 0.20, 0.2, 0.10, 9.0, 10.0, 11.0, 12.0, 13.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-04", 2, 0.0, 0.2, 0.11, 9.0, 10.0, 11.0, 12.0, 13.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-05", 3, 0.21, 0.27, 0.29, 9.0, 10.0, 11.0, 12.0, 13.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-06", 4, 0.29, 0.01, 0.27, 9.0, 10.0, 11.0, 12.0, 13.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-07", 5, 0.0, 0.2, 0.18, 9.0, 10.0, 11.0, 12.0, 13.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-08", 6, 0.10, 0.11, 0.11, 9.0, 10.0, 11.0, 12.0, 13.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-09", 7, 0.11, 0.16, 0.0, 9.0, 10.0, 12.0, 13.0, 14.0), 
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-10", 8, 0.19, 0.25, 0.0, 9.0, 10.0, 11.0, 12.0, 13.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-11", 9, 0.01, 0.0, 0.01, 9.0, 10.0, 11.0, 12.0, 13.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-12", 10, 0.23, 0.1, 0.05, 9.0, 10.0, 11.0, 12.0, 13.0),

            # Days 11-29 have p_above_2y < 0.30, p_above_5y < 0.30, and p_above_20y < 0.30
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-13", 11, 0.29, 0.24, 0.22, 17.0, 18.0, 19.0, 24.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-14", 12, 0.29, 0.29, 0.10, 17.0, 18.0, 19.0, 25.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-15", 13, 0.29, 0.28, 0.19, 17.0, 18.0, 19.0, 303.0, 405.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-16", 14, 0.23, 0.22, 0.28, 17.0, 18.0, 19.6, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-17", 15, 0.2, 0.1, 0.0, 17.0, 18.0, 19.0, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-18", 16, 0.29, 0.2, 0.03, 17.0, 18.0, 19.0, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-19", 17, 0.28, 0.24, 0.0, 17.0, 18.0, 19.0, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-20", 18, 0.29, 0.23, 0.27, 17.0, 18.0, 19.2, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-21", 19, 0.22, 0.13, 0.01, 17.0, 18.0, 19.0, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-22", 20, 0.2, 0.14, 0.06, 17.0, 18.0, 19.0, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-23", 21, 0.24, 0.22, 0.18, 17.0, 18.0, 19.0, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-24", 22, 0.2, 0.12, 0.19, 17.0, 18.0, 19.0, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-25", 23, 0.17, 0.15, 0.03, 17.0, 18.0, 19.0, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-26", 24, 0.23, 0.2, 0.12, 17.0, 18.0, 19.0, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-27", 25, 0.29, 0.29, 0.28, 17.0, 18.0, 19.4, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-28", 26, 0.26, 0.14, 0.04, 17.0, 18.0, 19.0, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-29", 27, 0.29, 0.25, 0.16, 17.0, 18.0, 19.3, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-30", 28, 0.23, 0.22, 0.11, 17.0, 18.0, 19.0, 20.0, 21.0),
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-31", 29, 0.27, 0.2, 0.29, 17.0, 18.0, 19.0, 20.0, 21.0),

            # Day 19 has p_above_2y < 0.30, p_above_5y < 0.30, and p_above_20y < 0.30 but the largest median discharge = 19.9
            (8.275, 2.325, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-11-01", 30, 0.24, 0.24, 0.04, 17.0, 18.0, 19.9, 20.0, 21.0),
        ]
