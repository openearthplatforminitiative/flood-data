...
class TestSparkUtilities(unittest.TestCase):
    ...
    def test_compute_peak_timing(self):
        ...
        data_black_border = [
            ...
            (2.275, 2.0, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-03", 1, 0.2, 0.15, 0.05, 9.0, 10.0, 11.0, 12.0, 13.0),

            # Day 2 has the highest severity with p_above_20y = 0.30
            (2.275, 2.0, 10.0, "2023-10-01", "2023-10-02", "2023-10-02", "2023-10-04", 2, 0.50, 0.45, 0.30, 12.0, 13.0, 14.0, 15.0, 16.0),
